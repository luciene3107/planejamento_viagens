...
describe("auth.service login", () => {
  ...
  it("returns access token and expiration when credentials are valid", async () => {
  ...
  it("returns unauthorized with a generic message for wrong password", async () => {
    User.findOne.mockResolvedValue({
      _id: "507f1f77bcf86cd799439011",
      password: "hashed-password",
      isActive: true,
  ...
  it("returns unauthorized with a generic message when user is not found", async () => {
